package dev.selfmadesystem.dmm.ui.screen.installer
...
import dev.selfmadesystem.dmm.installer.step.StepStatus
import dev.selfmadesystem.dmm.ui.viewmodel.installer.InstallerViewModel
import dev.selfmadesystem.dmm.ui.widgets.dialog.BackWarningDialog
import dev.selfmadesystem.dmm.ui.widgets.dialog.DownloadFailedDialog
import dev.selfmadesystem.dmm.ui.widgets.installer.StepGroupCard
...
class InstallerScreen(
    ...
    override fun Content() {
        ...
        val intentListener: (Intent) -> Unit = remember {
            {
                val msg = it.getStringExtra("dmm.extras.EXTRA_MESSAGE")
