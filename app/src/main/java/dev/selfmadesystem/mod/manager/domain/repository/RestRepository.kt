package dev.selfmadesystem.mod.manager.domain.repository

import dev.selfmadesystem.mod.manager.network.service.RestService
import dev.selfmadesystem.mod.manager.network.utils.transform
