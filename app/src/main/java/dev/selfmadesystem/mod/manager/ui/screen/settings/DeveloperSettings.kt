package dev.selfmadesystem.mod.manager.ui.screen.settings
...
import dev.selfmadesystem.mod.manager.ui.components.NavBarSpacer
import dev.selfmadesystem.mod.manager.ui.components.settings.SettingsButton
import dev.selfmadesystem.mod.manager.ui.components.settings.SettingsHeader
import dev.selfmadesystem.mod.manager.ui.components.settings.SettingsItemChoice
import dev.selfmadesystem.mod.manager.ui.components.settings.SettingsSwitch
import dev.selfmadesystem.mod.manager.ui.components.settings.SettingsTextField
