package dev.selfmadesystem.mod.manager.ui.viewmodel.home
...
import dev.selfmadesystem.mod.manager.domain.manager.InstallMethod
...
import dev.selfmadesystem.mod.manager.installer.Installer
import dev.selfmadesystem.mod.manager.installer.session.SessionInstaller
import dev.selfmadesystem.mod.manager.installer.shizuku.ShizukuInstaller
import dev.selfmadesystem.mod.manager.network.dto.Release
import dev.selfmadesystem.mod.manager.network.utils.CommitsPagingSource
import dev.selfmadesystem.mod.manager.network.utils.dataOrNull
import dev.selfmadesystem.mod.manager.network.utils.ifSuccessful
import dev.selfmadesystem.mod.manager.utils.DiscordVersion
import dev.selfmadesystem.mod.manager.utils.isMiui
